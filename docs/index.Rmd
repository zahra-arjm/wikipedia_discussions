...
```{r fig.align = 'center', out.width = "50%", fig.show='hold', fig.cap = "Max method; "escalated" graph on the left, "non-escalated" graph on the right"}
...
```{r fig.align = 'center', out.width = "50%", fig.show='hold', fig.cap = "Min method; "escalated" graph on the left, "non-escalated" graph on the right"}
...
```
```{r fig.align = 'center', out.width = "50%", fig.show='hold', fig.cap = "All method; "escalated" graph on the left, "non-escalated" graph on the right"}
